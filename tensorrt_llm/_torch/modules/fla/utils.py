...
COMPILER_MODE = TRTLLMENV.get("FLA_COMPILER_MODE") == "1"
FLA_CI_ENV = TRTLLMENV.get("FLA_CI_ENV") == "1"
...
SUPPRESS_LEVEL = int(TRTLLMENV.get("GDN_RECOMPUTE_SUPPRESS_LEVEL", "0"))
...
use_cuda_graph = is_nvidia and TRTLLMENV.get("FLA_USE_CUDA_GRAPH", "0") == "1"
