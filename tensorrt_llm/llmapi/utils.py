...
def enable_llm_debug() -> bool:
    ...
    if _enable_llm_debug_ is None:
        _enable_llm_debug_ = TRTLLMENV.get("TLLM_LLM_ENABLE_DEBUG", "0") == "1"
...
def enable_llmapi_debug() -> bool:
    ...
    if _enable_llmapi_debug_ is None:
        _enable_llmapi_debug_ = TRTLLMENV.get("TLLM_LLMAPI_ENABLE_DEBUG",
                                              "0") == "1"
...
def enable_worker_single_process_for_tp1() -> bool:
    ...
    return TRTLLMENV.get("TLLM_WORKER_USE_SINGLE_PROCESS", "0") == "1"
